...
int main(int argc, char const *argv[])
{
    ...
    string str("In computer science, an FM-index is a compressed full-text substring index based on the Burrows-Wheeler transform, with some similarities to the suffix array. It was created by Paolo Ferragina and Giovanni Manzini");
    str += "#";
    ...
    //cout << "-> original = " << str << "\n-> encoded  = ";
    //cout << mtf.encode(str) << endl;
    //mtf.compress(mtf.encode(str));
