...
void generatingMatrix(std::vector<std::vector<int>> &a, int row, int col)
{
...
void multiplyMatrix(std::vector<std::vector<int>> &a, std::vector<std::vector<int>> &b, int m, int n, int q)
{
